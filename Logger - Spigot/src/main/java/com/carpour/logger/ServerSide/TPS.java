    ...
    public void run() {
        ...
        if (main.getConfig().getBoolean("Log-Server.TPS")) {
            ...
            if (main.getConfig().getBoolean("Log-to-Files")) {
                ...
                //Discord
                if (DiscordFile.get().getBoolean("Discord.Server-Side.TPS.Enable")) {

                    if (getTPS() <= main.getConfig().getInt("TPS.Value-Medium")) {

                        Discord.TPS(Objects.requireNonNull(Messages.get().getString("Discord.Server-Side.TPS-Medium")).replaceAll("%TPS%", String.valueOf(getTPS())), false);

                    } else if (getTPS() <= main.getConfig().getInt("TPS.Value-Critical")) {

                        Discord.TPS(Objects.requireNonNull(Messages.get().getString("Discord.Server-Side.TPS-Critical")).replaceAll("%TPS%", String.valueOf(getTPS())), false);
                    }
                }
