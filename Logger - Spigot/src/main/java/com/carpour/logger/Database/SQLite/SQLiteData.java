...
public class SQLiteData {
    ...
    public static void insertBook(String serverName, String world, Player player, int pages, List<String> content, String signed_by, boolean staff){
        try {
            PreparedStatement book_editing = plugin.mySQL.getConnection().prepareStatement("INSERT IGNORE INTO Book_Editing (Server_Name, Date, World, Player_Name, Page_Count, Page_Content, Signed_by, Is_Staff) VALUES(?,?,?,?,?,?,?,?)");
