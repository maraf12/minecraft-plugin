        ...
        if (main.getConfig().getBoolean("Log-Server.Console-Commands")) {
            ...
            if (main.getConfig().getBoolean("Log-to-Files")) {
                ...
                try {
                    ...
                    out.write(Objects.requireNonNull(Messages.get().getString("Files.Server-Side.Console-Commands")).replaceAll("%time%", dateFormat.format(date)).replaceAll("%message%", msg) + "\n");
                    out.close();
            ...
            //Discord
            if (DiscordFile.get().getBoolean("Discord.Server-Side.Console-Commands.Enable")) {

                Discord.console(Objects.requireNonNull(Messages.get().getString("Discord.Server-Side.Console-Commands")).replaceAll("%message%", msg), false);
            }
